...
public class MyService extends Service {
    ...
    private class myLocationListener implements LocationListener {
        ...
        public void onLocationChanged(Location location) {
            TextView _longitude = (TextView) DeviceMovingSpeed.ctx.findViewById(R.id.longitude);
            TextView _latitude = (TextView) DeviceMovingSpeed.ctx.findViewById(R.id.latitude);
            TextView _distance = (TextView) DeviceMovingSpeed.ctx.findViewById(R.id.distance);
            TextView _vitesse = (TextView) DeviceMovingSpeed.ctx.findViewById(R.id.vitesse);
